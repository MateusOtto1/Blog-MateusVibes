...
fetch("https://api-rest-post-diegocandido.herokuapp.com/postagens/").then(response => response.json()).then(result => {
    console.log(result);
    document.querySelector(".titulo-post1").innerHTML = result[0].title;
    document.querySelector(".descricao-post1").innerHTML = result[0].description;
    ...
    document.querySelector(".titulo-post5").innerHTML = result[4].title;
    document.querySelector(".descricao-post5").innerHTML = result[4].description;
    document.querySelector(".nome-criador5").innerHTML = result[4].profileName;
